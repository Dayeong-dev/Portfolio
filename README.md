# 포트폴리오(Portfolio)
작업했던 프로젝트와 경력을 정리한 포트폴리오 사이트입니다. <br>
Vanilla JS(순수 자바스크립트)로 개발했으며, 직접 구현 경험을 쌓기 위해 시작한 프로젝트입니다. <br>
일부 기능은 CDN 라이브러리(FontAwesome, IntersectionObserver)를 사용했습니다.
